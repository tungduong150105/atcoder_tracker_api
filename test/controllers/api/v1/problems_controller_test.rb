  ...
  module V1
    class ProblemsControllerTest < ActionDispatch::IntegrationTest
      ...
      test "should get index" do
        get api_v1_problems_url, as: :json
      ...
      test "should create problem" do
        ...
        assert_difference("Problem.count") do
          post api_v1_problems_url, params: { problem: new_problem }, as: :json
        end
      ...
      test "should show problem" do
        get api_v1_problem_url(@problem), as: :json
        assert_response :success
      end
      ...
      test "should update problem" do
        ...
        patch api_v1_problem_url(@problem), params: {
          problem: {
      ...
      test "should destroy problem" do
        assert_difference("Problem.count", -1) do
          delete api_v1_problem_url(@problem), as: :json
        end
